...
import notificationsGmail from "../../../public/images/notifications-gmail.png";

const FooterBanner = ({ cta }: { cta: "google" | "native" }) => {
  return (
    <Box
      color="white"
    ...
    >
      <Flex direction={{ base: "column", lg: "row" }}>
        <Box alignSelf="center" pt={{ base: 16, lg: 0 }}>
          <Heading
            variant="h2"
        ...
        >
          <Image
            src={cta === "google" ? notificationsGmail : notifications}
            width={515}
            height={365.5}
            quality={100}
