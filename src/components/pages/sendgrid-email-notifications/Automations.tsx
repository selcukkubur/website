    ...
    <FeatureSection
      ...
      graphic={
        ...
        >
          ...
          >
            <Image
              src={require("../../../../public/images/pages/sendgrid-email-notifications/automations-bg.png")}
              alt=""
            />
          </Box>
          ...
          <Box pos="absolute" top="11%" left="1%" right="1%" display="flex">
            <Image
              src={require("../../../../public/images/pages/sendgrid-email-notifications/automations.gif")}
              alt=""
            />
          </Box>
          ...
          >
            <Image
              src={require("../../../../public/images/pages/sendgrid-email-notifications/automations-fg.png")}
              alt=""
            />
          </Box>
        </Box>
