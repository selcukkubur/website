    ...
    >
      <Box>
        ...
        <Text mt={6} mb={10} variant="body1" color="whiteAlpha.900">
          Courier makes it easy to add the key social notifications your app
          needs to keep users engaged and in the loop. With a full featured API,
          SDKs for all major languages, and a direct integration with Segment,
          there’s multiple ways Courier can power your social notifications.
        </Text>
      </Box>
