...
const ApiCalls = () => (
  ...
  >
    ...
    >
      <Box pt={2}>
        <Heading as="h3" variant="h3" maxW={{ lg: "440px" }}>
        ...
        <Text
          ...
          maxW={{ lg: "480px" }}
        >
          Courier's Automations API allows you to create ad hoc automations,
          override existing automations, and otherwise programatically interact
          with any automations features.
        </Text>
