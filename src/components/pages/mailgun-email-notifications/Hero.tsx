...
const Hero = () => (
  ...
  >
    <FeatureSection
      ...
      tag={{
        label: "Mailgun Product Notifications",
        textColor: "white",
      ...
      graphic={
        <Box ml="38px" display={{ base: "none", lg: "block" }} mb={-10}>
          <Image
            src={require("../../../../public/images/pages/mailgun-email-notifications/hero.png")}
            width={744}
            height={651.5}
            layout="fixed"
            alt=""
    ...
    >
      <Box>
        ...
        <Text mt={6} mb={10} variant="body1" color="whiteAlpha.900">
          Courier integrates directly with Mailgun to provide a complete email
          notification system. Simply plugin your Mailgun API key and
